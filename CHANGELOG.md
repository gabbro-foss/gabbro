...
### Added
- Multi-language expansion (partial — 22 of 35 locales, remainder next session): language picker refactored from chips to scrollable sorted list (both Settings and onboarding). New locales added: pt_PT, pt_BR, da, nb, nn, sv, fi, et, hu, lt, lv, ru, uk, bg, pl, cs. `LanguageChoice` enum expanded; `_localeFor()` helper handles complex BCP-47 tags (pt_PT, pt_BR, sr_Latn, zh_CN, zh_TW). Remaining: sk, hr, sl, sr_Latn, el, ja, ko, zh_CN, zh_TW, kk, eu, yo.
