...
- Investigate keyboard accessibility sweep: tab/shift+tab traversal, enter/space activate, esc dismiss, arrows in lists, ctrl+f focus, ctrl+l lock. no ctrl+c to avoid data leakage. no super key usage.
