...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -628934846;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        19 => wire__crate__api__vault_bridge__import_from_enpass_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        21 => wire__crate__api__vault_bridge__init_vault_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__passphrase_generator__passphrase_entropy_bits_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__vault_bridge__unlock_vault_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__vault_bridge__update_entry_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        23 => wire__crate__api__vault_bridge__lock_vault_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
