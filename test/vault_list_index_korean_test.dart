...
// Cycle 3: a Korean (ko) locale buckets syllables by their leading consonant
// and shows the 14-jamo bar.
...
void main() {
  testWidgets('ko locale: syllable buckets under leading-consonant header',
      (tester) async {
    _setPhone(tester);
    await tester.pumpWidget(_screen([_entry('1', '김치')], const Locale('ko')));
    await tester.pumpAndSettle();

    expect(_header('ㄱ'), findsOneWidget);
    expect(_bar(tester).letters, contains('ㅎ'));
    expect(_bar(tester).letters, contains('ㄱ'));
